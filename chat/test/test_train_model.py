...
class IntentModel:
    def __init__(self, model_name, proprocess):
        ...
        self.labels = {162: '서귀포 쇼핑몰 추천', 161: '제주 쇼핑몰 추천', 160: '서귀포 주점 맛집 추천', 159: '서귀포시 카페 추천', 158: '서귀포 한식 맛집 추천',
                       ...
                       106:'12월 제주 날씨', 105: '11월 제주 날씨', 104: '10월 제주 날씨', 103: '09월 제주 날씨',
                       102: '08월 제주 날씨', 101: '07월 제주 날씨', 100: '06월 제주 날씨', 99: '05월 제주 날씨', 98: '04월 제주 날씨', 97: '03월 제주 날씨', 96: '02월 제주 날씨', 95: '01월 제주 날씨',
                       94: '겨울 제주 날씨', 93: '가을 제주 날씨', 92: '여름 제주 날씨', 91: '봄 제주 날씨', 0: '첫 인사', 1: '끝 인사', 2: '욕', 3: '결제 영수증', 4: '결제 전 예약 변경', 5: '결제 카드 변경',
                       6: '결제 카드 할부 범위', 7: '결제 확인', 8: '대한항공 수화물', 9: '미성년자 회원 가입', 10: '비밀번호 변경', 11: '비밀번호 오류', 12: '비행 탑승 귀통증', 13: '숙박 객실 변경',
                       14: '숙박 객실 유형', 15: '숙박 객실 추가', 16: '숙박 결제 취소', 17: '숙박 당일 예약', 18: '숙박 당일 취소', 19: '숙박 딜레이 체크인', 20: '숙박 미성년자 이용 가능', 21: '숙박 사전 객실 배정',
                       22: '숙박 애완동물 동반', 23: '숙박 예약 대기', 24: '숙박 이용 가능인원 확인', 25: '숙박 이용객 확인', 26: '숙박 체크인 바우처 필요', 27: '숙박 체크인 절차', 28: '숙박 추가 요금',
                       29: '숙박 퇴실 시간 확인', 30: '숙박 퇴실 연장', 31: '숙박 퇴실 확인', 32: '숙박 현장 추가 결제 확인', 33: '아시아나항공 수화물', 34: '애완 동반 비행', 35: '에어부산 수화물', 36: '에어서울 수화물',
                       37: '예약 내역 변경', 38: '예약 내역 확인', 39: '예약 외국인 가능', 40: '예약 최소 출발일', 41: '예약 취소', 42: '예약 환불 규정', 43: '예약완료시 예약 확정 확인', 44: '임산부 비행 확인',
                       45: '전화 상의 카드 결제', 46: '제주항공 수화물', 47: '좌석확인', 48: '좌석확정확인', 49: '진에어 수화물', 50: '출국 - 입국확인', 51: '카드 결제 취소 확인', 52: '타인 카드 결제', 53: '티웨이항공 수화물',
                       54: '항공 e - ticket', 55: '항공 결제 수단 변경', 56: '항공 결제 완료 확인', 57: '항공 기상 취소', 58: '항공 노쇼', 59: '항공 수수료', 60: '항공 수화물', 61: '항공 스케줄 변경',
                       62: '항공 스케줄 확인 필요', 63: '항공 예약 변경', 64: '항공 예약 사전 좌석 배정', 65: '항공 예약 취소', 66: '항공 외국인 탑승자', 67: '항공 요금', 68: '항공 요금 변경', 69: '항공 탑승 신분증',
                       ...
                       84: 'SNS 회원 로그인', 85: 'SNS 회원 연동 해체', 86: '결제 내역 확인'}
...
if __name__ == '__main__':
    ...
    TestChat = TestChat()
    TestChat.predict_test(question)
    # p = Preprocess(word2index_dic='./data/chatbot_dict.bin', userdic='./data/user_dic.tsv')
    #
